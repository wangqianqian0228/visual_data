...
- series
  ...
  - series里面有name属性，则legend里面的data可以不用写。
...
- grid：直角坐标系内绘图网格。 gird可以控制柱状图，线形图，图表大小
...
需求2： 修改图例组件中的文字颜色 #4c9bfd， 图例中的文字颜色写在textStyle里面 距离右侧 right 为 10%
